...
public class Mail {
    ...
    public String send() {
        ...
        try {
            ...
            mimebodypart1.setContent("<html><font color='#AA00FF'>" + mensaje + "<br> Missatge enviat el " + Data.datactual() + "</font></html>", "text/html");
    ...
    public String toString() {
        return "Mail{" + "user=" + user + ", pass=" + pass + ", destino=" + destino
                + ", subject=" + subject + ", mensaje=" + mensaje + ", props=" + props + '}';
    }
